...
function getTopDocumentaries() {
    const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=99&sort_by=vote_average.desc&vote_count.gte=1000&include_adult=false`;
...
function displayTopDocumentaries() {
...
getTopDocumentaries()
    ...
    topDocumentariesMovies.forEach((data, index) => {
      ...
      if (index === topDocumentariesMovies.length - 1) {

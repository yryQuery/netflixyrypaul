...
function getTopSciFi() {
    const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=878&sort_by=vote_average.desc&vote_count.gte=1000&include_adult=false`;
...
getTopSciFi()
    ...
    topSciFiMovies.forEach((data, index) => {
      ...
      if (index === topSciFiMovies.length - 1) {
